...
describe("GET /todo", function () {
    it("should respond with status 404 if list doesnt exist", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, server.get("/todo")];
                case 1:
                    response = _a.sent();
    ...
    it("should respond with status 200 and empty array when there are no items on the list", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    createEmptyTodoList();
                    return [4 /*yield*/, server.get("/todo")];
                case 1:
                    response = _a.sent();
